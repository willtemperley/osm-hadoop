...
public class GeoTiffReader extends AbstractGridCoverage2DReader implements GridCoverage2DReader {
	...
	private Logger LOGGER = org.geotools.util.logging.Logging.getLogger(org.geotools.gce.geotiff.GeoTiffReader.class.toString());
	...
	/** With this java switch I can control whether or not an external PRJ files takes precedence over the internal CRS definition*/
	static boolean OVERRIDE_INNER_CRS=Boolean.valueOf(System.getProperty(org.geotools.gce.geotiff.GeoTiffReader.OVERRIDE_CRS_SWITCH, "True"));
...
//                    MapInfoFileReader mifReader = parseMapInfoFile(source);
                    MapInfoFileReader mifReader = null;//parseMapInfoFile(source);
                    if(mifReader!=null){
