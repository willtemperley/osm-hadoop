...
//    job.setOutputValueClass(classOf[IntWritable])
  ...
  /**
    *
    */
  class WayRasterMapper extends Mapper[LongWritable, WayWritable, ImmutableBytesWritable, Text] {

    var tag: String = _

    override def setup(context: Mapper[LongWritable, WayWritable, ImmutableBytesWritable, Text]#Context): Unit = {
...
//    val grid = new GlobalGrid(width, height)
    ...
    override def map(key: LongWritable, value: WayWritable,
                     context: Mapper[LongWritable, WayWritable, ImmutableBytesWritable, Text]#Context): Unit = {
  ...
  //
  class BufferReducer extends TableReducer[ImmutableBytesWritable, Text, ImmutableBytesWritable] {
    ...
    override def reduce(key: ImmutableBytesWritable, values: Iterable[Text],
                        context: Reducer[ImmutableBytesWritable, Text, ImmutableBytesWritable, Mutation]#Context): Unit = {
